...
class AlocacoesSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('alocacoes')->insert(['projeto_id' => 2, 'desenvolvedor_id' => 1, 'horas_semanais' => 16]);
        DB::table('alocacoes')->insert(['projeto_id' => 3, 'desenvolvedor_id' => 1, 'horas_semanais' => 17]);
        DB::table('alocacoes')->insert(['projeto_id' => 3, 'desenvolvedor_id' => 2, 'horas_semanais' => 18]);
        DB::table('alocacoes')->insert(['projeto_id' => 3, 'desenvolvedor_id' => 3, 'horas_semanais' => 19]);
    }
}
